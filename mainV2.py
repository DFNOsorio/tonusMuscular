...
# EMG = filter_EMG(patient1.EMG_avg)
#
# RMS = RMS_whole_segment(EMG)
#
# freq, pxx = fourier_EMG(EMG)
#
# plt.figure()
# plt.plot(patient1.EMG_RMS["Standing_EO"][:,1])
# plt.show()
# plt.plot(patient1.fre_EMG["Standing_EO"][:,1], patient1.pxx_EMG["Standing_EO"][:,1])
# plt.show()
# plt.plot(RMS["Standing_EO"][:,1])
# plt.show()
# plt.plot(freq["Standing_EO"][:,1], pxx["Standing_EO"][:,1])
# plt.show()
