...
freqs, FFT = fourier_COP(patient1.COP)

#plt.plot(freqs1["Arms_extension"][:,0], FFT1["Arms_extension"][:,0])
#plt.show()
...
#fig1_max_platform = graph(patient1.EMG_max_values, patient1.COP,"Emma", trajec, platform = True)
